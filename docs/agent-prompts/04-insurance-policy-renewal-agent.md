...
Greeting*. English (canonical): "Hello, this is {{agent_name}} calling on behalf of {{company_name}} — a
quick reminder about your policy renewal. Do you have a moment?"
...
Ask (canonical English — deliver naturally in the configured language): "Your {{policy_type}} policy is
due for renewal on {{due_date}}. Were you already aware of this, and do you plan to go ahead with the
renewal?"
...
- **Branch A — confirmed renewing:** "Wonderful — thank you for confirming. You're all set for {{due_date}}."
- **Branch B — undecided / declined / needs a human:** "Understood — I'll have someone from our team reach out to help with that."
...
### Closings
- **Branch A — Hindi:** "बहुत बढ़िया — confirm करने के लिए धन्यवाद। {{due_date}} के लिए सब तैयार है।"
- **Branch A — Hinglish:** "Bahut badhiya — confirm karne ke liye dhanyavaad. {{due_date}} ke liye sab set hai."
- **Branch B — Hindi:** "ठीक है — हमारी team की तरफ से कोई आपसे इस बारे में संपर्क करेगा।"
- **Branch B — Hinglish:** "Theek hai — hamari team ki taraf se koi aapse iss baare mein contact karega."
...
| Section 6 — reschedule day/time | `captureField({ field: "reschedule_date"/"reschedule_time", value })` | Same generic tool as other verticals. |
