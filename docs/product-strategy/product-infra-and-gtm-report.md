...
**Superseded by `docs/reference/resources.md`** (2026-07-17, written after Audit #7's real live-infra
...
involved. See `docs/reference/resources.md` for the corrected version.
