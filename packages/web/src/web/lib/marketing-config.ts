...
export const PRICING_TIERS = [
  {
    ...
    features: [
      "Up to 250 calls/month included",
      "Core flows (cart recovery, COD, order updates)",
      "Shopify integration",
  ...
  },
  {
    ...
    features: [
      "Up to 1,500 calls/month included",
      "All flows (COD, cart recovery, booking, feedback)",
      "CRM sync (HubSpot, Salesforce, GoHighLevel)",
  ...
  },
  {
    ...
    features: [
      "Custom volume & dedicated numbers",
      "Priority carrier routing & custom integrations",
      "SLAs & dedicated support",
      "Full audit logs & compliance reviews",
    ],
    cta: "Talk to sales",
  },
] as const;
