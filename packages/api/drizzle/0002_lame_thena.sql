...
ALTER TABLE "caller_memory" ADD COLUMN "org_id" text DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE "caller_memory" DROP CONSTRAINT "caller_memory_pkey";--> statement-breakpoint
