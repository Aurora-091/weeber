...
ALTER TABLE "org_agent_configs" ADD COLUMN IF NOT EXISTS "phone_number_id" integer;--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "org_phone_numbers" ADD CONSTRAINT "org_phone_numbers_org_id_orgs_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."orgs"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object OR invalid_table_definition OR duplicate_table THEN null;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "org_phone_numbers_org_id_idx" ON "org_phone_numbers" USING btree ("org_id");--> statement-breakpoint
DO $$ BEGIN
