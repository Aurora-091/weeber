...
--> statement-breakpoint
ALTER TABLE "call_latency" ADD CONSTRAINT "call_latency_call_id_calls_id_fk" FOREIGN KEY ("call_id") REFERENCES "public"."calls"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "caller_memory" ADD CONSTRAINT "caller_memory_last_call_id_calls_id_fk" FOREIGN KEY ("last_call_id") REFERENCES "public"."calls"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shop_links" ADD CONSTRAINT "shop_links_org_id_orgs_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."orgs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "shopify_contacts" ADD CONSTRAINT "shopify_contacts_org_id_orgs_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."orgs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tool_calls" ADD CONSTRAINT "tool_calls_call_id_calls_id_fk" FOREIGN KEY ("call_id") REFERENCES "public"."calls"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "shopify_contacts_org_e164_idx" ON "shopify_contacts" USING btree ("org_id","e164");--> statement-breakpoint
CREATE UNIQUE INDEX "shopify_webhook_events_dedupe_idx" ON "shopify_webhook_events" USING btree ("shop","topic","idempotency_key");